...
> Source: the user-provided `en.subject.pdf`. This English Markdown transcription preserves the subject wording and requirements; headings, spacing and lists are formatted for reading. Figure pages are reproduced below.

<!-- Source PDF SHA-256: 5609bfe3058fc2db9abd7460281f70eec19500f3283a86ab480599cf70a9e9f2 -->
...
- [VI. Let the drone fly](#vi-let-the-drone-fly)
- [VII. Mandatory Part](#vii-mandatory-part)
...
![Figures VII.1 and VII.2: Map easy 2 and Map medium 3](subject_assets/maps_easy_medium.png)
...
![Figure VII.3: Map hard 2](subject_assets/map_hard.png)
